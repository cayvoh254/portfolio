      ...
      <div style={{ maxWidth: 680, margin: "0 auto", textAlign: "center" }}>
        ...
        <h2
          style={{
            ...
            color: "var(--t1)", letterSpacing: "-.02em",
            lineHeight: 1.1, marginBottom: 16,
          }}
        >
          Let&apos;s <em style={{ fontStyle: "italic", color: "var(--blue)" }}>connect</em>
        </h2>
        <p
          style={{
            fontSize: 15, lineHeight: 1.75, color: "var(--t2)",
            maxWidth: "44ch", margin: "0 auto 30px",
          }}
        >
          Open to technical support, cybersecurity, and remote opportunities globally.
          Whether you have a role, a question, or just want to say hi — my inbox is open.
        </p>
